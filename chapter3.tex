...
Für jede Aktion wurden aktuell bestehende wie auch vorstellbare Umsetzungen für die Modalitäten Haptik, Touch, Geste und Sprache gesammelt (siehe \fref{fig:ConnectedMindErgebnisse} rechtes Bild und \fref{tab:table1}). 
...
In \fref{tab:table1} sind alle Vorschläge der verschiedenen Modalitäten aufgelistet.
