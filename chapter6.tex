...
Hierbei soll die Lautstärke von 50\% auf 80\% erhöht werden, mit den Modalitäten Sprache und Geste, siehe \fref{fig:UseCasesEvalMedienS}. 
...
Hier werden 2 Modalitäten (Touch und Sprache) mit insgesamt vier Moduswechseln verwendet. 
...
\end{figure}
In \fref{fig:Vorhersagezeit_ohne_Wechselkosten} sind die Unterschiede der beiden Modelle zu sehen. 
